...
import { StyleSheet, Text, View, TouchableOpacity, LayoutAnimation, UIManager, Platform } from 'react-native'
        ...
        {expandedNotification && (
          <View style={styles.expandedSection}>
            <TouchableOpacity style={[styles.subButton, { backgroundColor: theme.colors.primary }]}>
              ...
              <Icon name="options-outline" size={24} color={theme.colors.text} style={styles.icon} />
            </TouchableOpacity>
            <TouchableOpacity style={[styles.subButton, { backgroundColor: theme.colors.primary }]}>
              <Text style={[styles.buttonText, { color: theme.colors.text }]}>Tin tức trong nước</Text>
              <Icon name="settings-outline" size={24} color={theme.colors.text} style={styles.icon} />
            </TouchableOpacity>
            <TouchableOpacity style={[styles.subButton, { backgroundColor: theme.colors.primary }]}>
